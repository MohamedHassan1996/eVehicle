...
use App\Http\Controllers\Api\V1\VehicleSpeardsheetExportController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('vehicle-logs-export-spreadsheet', [VehicleSpeardsheetExportController::class, 'export']);
